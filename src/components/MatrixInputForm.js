  ...
  render() {
    return (
      <div className="profile-card">
        {!this.state.flag ? (
          <form onSubmit={(e) => this.handelSubmit(e)} autoComplete="off">
          ...
          <BoxContainer
            rowCount={parseInt(this.state.matrixRowCount, 10)}
            colCount={parseInt(this.state.matrixColCount, 10)}
            timeInterval={parseInt(this.state.time, 10)}
            boxes={parseInt(this.state.numbeOfBoxes, 10)}
          />
        )}
      </div>
    );
